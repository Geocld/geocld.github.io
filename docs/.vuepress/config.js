...
module.exports = {
  title: "lijiahao's blog",
  description: '前端，移动端和杂七杂八的技术分享', // 描述,以 <meta> 标签渲染到页面html中
  ...
  themeConfig: { // 主题配置
    ...
    repo: 'https://github.com/Geocld', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, link: String}
      name: 'lijiahao', // 必需
      link: 'https://github.com/geocld' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:lijiahao53@gmail.com'
        },
        {
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'lijiahao | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    }
  },
  plugins: [ // 插件
